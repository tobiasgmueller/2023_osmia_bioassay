...
Markdown document for ITS pipeline of 2023 osmia bioassay data

this serves primarily to store quality score and choice information from the 16s pipeline script

This is not intended as a standalone but will follow the ITS pipe script which can be run as a single script. This file will pull from those outputs
...
track<-read.csv(file="sequencing_results/ITS/track_through_pipe.csv")
track
```
...
```
One taxa was found as a contaminants and removed
